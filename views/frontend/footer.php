...
<footer>
		<div class="footer-top-first">
			<div class="container py-md-5 py-sm-4 py-3">
				...
				<h2 class="footer-top-head-w3l font-weight-bold mb-2">Tienda Informatica Jerusalen :</h2>
				<p class="footer-main mb-4">
					Si está considerando una nueva computadora portátil, escritorio, buscando partes de computadoras portátiles y de escritorio entre otros equipos electronicos, le facilitamos encuentre exactamente lo que necesita a un precio asequible.
					Ofrecemos precios bajos todos los días en computadoras portátiles, computadoras de escritorio, cámaras y videocámaras, audio, video y más.
				</p>
				<!-- //footer first section -->
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids">
						<h3 class="text-white font-weight-bold mb-3">Categorías</h3>
						<ul>
							<li class="mb-3">
					...
					<div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
						<!-- newsletter -->
						<h3 class="text-white font-weight-bold mb-3">Boletin informativo</h3>
						<p class="mb-3">Entrega gratuita en tu primer pedido!</p>
						...
						<div class="footer-grids  w3l-socialmk mt-3">
							<h3 class="text-white font-weight-bold mb-3">Siga con nosotros</h3>
							<div class="social">
								<ul>
									<li>
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="assets/tiendastyles/js/jquery-2.2.3.min.js"></script>
	<!-- //jquery -->
	...
	<script src="assets/tiendastyles/js/jquery.magnific-popup.js"></script>
	<script>
		$(document).ready(function () {
	...
	<!-- cart-js -->
	<!-- <script src="assets/tiendastyles/js/minicart.js"></script> -->
	<script>
        /*
	...
	<!-- scroll seller -->
	<script src="assets/tiendastyles/js/scroll.js"></script>
	<!-- //scroll seller -->
