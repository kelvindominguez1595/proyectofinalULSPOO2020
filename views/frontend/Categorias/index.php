					...
					<div class="wrapper">
                        ...
                        <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
                            ...
                            <div class="d-flex justify-content-center">
                                <div class="col-sm-12">
                                    <img src="assets/img/comming2.gif" class="img img-fluid" alt="">
                                </div>
                            </div>
                          <?php  
                          }else{                 
                            foreach ($listaProCa as $item) {
                            ?>
									...
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center border-top mt-4">
                                            ...
                                            <form action="?view=Venta&action=shopping_cart" method="post">
													<fieldset>
														<input type="hidden" name="vista" value="Productos&action=Categoria&id=<?php echo $categoria->id_categoria; ?>" />
