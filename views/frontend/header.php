...
<head>
	<title>Servicios Informáticos Jerusalén </title>
	<!-- Meta tag Keywords -->
	...
	<!-- Custom-Files -->
	<link href="assets/tiendastyles/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Bootstrap css -->
	<link href="assets/tiendastyles/css/style.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Main css -->
	<link rel="stylesheet" href="assets/tiendastyles/css/fontawesome-all.css">
				...
				<div class="col-md-9 header mt-4 mb-md-0 mb-4">
					<div class="row">
						...
						<div class="col-2 top_nav_right text-center mt-sm-0 mt-2">
                            ...
                            <!-- Shopping -->
								<form action="?view=Home&action=Shopping" method="post" class="last">
