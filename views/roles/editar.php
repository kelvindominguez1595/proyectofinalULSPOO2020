        ...
        <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="text" name="nombre" class="form-control form-control-user" required id="exampleFirstName" placeholder="Rol" value="<?php echo $data->nombre; ?>">
                    </div>
                    <div class="col-sm-6">
                        <textarea name="descripcion" id="" cols="10" rows="5" class="form-control " required placeholder="Descripción">
